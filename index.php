		...
		<div class="item active">
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>
						Working as a Web developer is always something very creative. The visual Element of the Web always makes me do something unique and build something creative.
					</p>
					<p>
		...
		<div class="item">
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>
						Building Standalone Desktop Softwares using Java &amp; C# is what i've always enjoyed developing. Working with Java is always so Comfortable for me.
					</p>
					<p>
						<a class="btn btn-large btn-primary" href="projects.php#jchat">See Work</a>
					</p>
				</div>
			</div>
		</div>
		<div class="item">
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>
						Building Android apps with Java again is the Language that I love the most is fun to do and additionaly I've worked with new Windows 8,8.1 app developments as well.
					</p>
					<p>
...
<div class="container marketing">
	...
	<h2>Featured Work</h2>
	<div class="fotorama" data-allowfullscreen="native" data-autoplay="true" data-stopautoplayontouch="false">
